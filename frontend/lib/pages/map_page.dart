...
class MapPageState extends State<MapPage> {
  // Set the default map to Boston Common
  ...
  Widget build(BuildContext context) {
    // Determine the image path based on the selected map
    final String currentMapImage =
        _selectedMap == MapSection.bostonCommon
            ? 'assets/MapNew.png' // Update with your actual image path
            : 'assets/MapNew2.png'; // Update with your actual image path

    // Determine the label for the toggle button (shows the OTHER map option)
    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          // Top Right Toggle Button (Replaces the Filter Icon)
          Positioned(
            top:
